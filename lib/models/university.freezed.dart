...
class _$_University implements _University {
  ...
  @override
  String toString() {
    return 'University(alphaTwoCode: $alphaTwoCode, domains: $domains, country: $country, stateProvince: $stateProvince, webPages: $webPages, name: $name)';
  }
...
abstract class _University implements University {
  factory _University(
      ...
      final String? stateProvince,
      final List<String>? webPages,
      final String? name}) = _$_University;
